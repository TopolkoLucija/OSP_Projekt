...
ggplot(data, aes(x = imdb_score)) +
  ...
  labs(title = "Ocjena filma", x = "IMDb score", y = "Broj filmova")
```
...
ggplot(data, aes(x = duration)) +
  ...
  labs(title = "Trajanje filmova 75% kvantil", x = "Trajanje (minute)", y = "Broj filmova")
...
ggplot(final_data, aes(x = country, y = count)) +
  ...
  labs(title = "Država snimanja", x = "Država", y = "Broj filmova")
...
ggplot(final_data, aes(x = language, y = count)) +
  geom_bar(stat = "identity", fill = "purple", color = "white") +
  labs(title = "Jezik filma", x = "Jezik", y = "Broj filmova")
